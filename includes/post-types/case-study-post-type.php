<?php
/**
 * case-study-post-type.php
 * Registers the case study content type.
 */
namespace FoundryFrame\PostTypes;

class CaseStudyPostType extends Abstract\AbstractPostType
{
    protected $post_type_name = 'case_study';
    protected $post_type_name_singular = 'Case Study';
    protected $post_type_name_plural = 'Case Studies';
